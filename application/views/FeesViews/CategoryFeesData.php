						...
						<div class="row align-items-center">
							<div class="col">
								...
								<li><a href="FeesDashboard">Fees</a></li>
									...
									<li class="breadcrumb-item active">/ View Fee</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-body">
										<div class="row">
											<div class="col-12">
												<h5 class="form-title"><span>Fee Details</span></h5>
											</div>
										
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													<label>Category<span class="login-danger">*</span></label>
													<input type="text" class="form-control" name="category" value="<?php echo $data->category;?>" readOnly>
												</div>
											</div>
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													<label>Fees<span class="login-danger">*</span></label>
                                                    <input type="text" class="form-control" name="fees" value="<?php echo $data->fees;?>" readOnly>
												</div>
											</div>
											<!-- <div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
											...
											<div class="col-12">
												<div>
													<a class="btn btn-primary" href="UpdateFees?id=<?php echo $data->id;?>">Edit</a>
