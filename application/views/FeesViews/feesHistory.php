...
function fillTable(data) {
    ...
    data.forEach((item, index) => {
        ...
        categoryCell.textContent = item[0]; // Assuming the first element is the category
        row.appendChild(categoryCell);

        let feesCell = document.createElement("td");
        feesCell.classList.add("text-center");
        feesCell.textContent = item[1]; // Assuming the second element is the fees
        ...
        viewButton.href = "ViewFeeData?id=" + item[2]; // Assuming the third element is the id
        viewButton.classList.add("btn", "btn-sm", "bg-success-light", "me-2");
        viewButton.innerHTML = '<i class="feather-eye"></i>';
        actionCell.appendChild(viewButton);

        let updateButton = document.createElement("a");
        updateButton.href = "UpdateFees?id=" + item[2];
        updateButton.classList.add("btn", "btn-sm", "bg-danger-light");
        updateButton.innerHTML = '<i class="feather-edit"></i>';
        actionCell.appendChild(updateButton);

        let deleteButton = document.createElement("button");
        deleteButton.classList.add("btn", "btn-sm", "bg-danger-light");
        deleteButton.setAttribute("onclick", "deleteModal(" + item[2] + ")");
