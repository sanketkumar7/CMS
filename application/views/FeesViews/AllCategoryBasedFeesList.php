...
<head>
		...
		document.addEventListener('DOMContentLoaded', function() {
			var FeesAddSuccess = document.getElementById('toast-container');
			if (FeesAddSuccess) {
				FeesAddSuccess.style.display = 'block';
				setTimeout(function() {
					FeesAddSuccess.style.display = 'none';
				}, 3000);
			} 
		});
	</script>
    ...
    <body>
	<?php
	$FeesAddSuccess = $this->session->flashdata('FeesAddSuccess');
	$FeesUpdateSuccess = $this->session->flashdata('FeesUpdateSuccess');
	$FeesDeleteSuccess = $this->session->flashdata('FeesDeleteSuccess');
	?>
	<?php if (isset($FeesAddSuccess)) : ?>
		<div id="toast-container" class="toast-container toast-top-right">
			<div class="toast toast-success" aria-live="polite" style="display: block;">
				<div class="toast-title text-center">Fees Added Successfully</div>
			</div>
		</div>
	<?php endif; ?>
	<?php if (isset($FeesUpdateSuccess)) : ?>
		<div id="toast-container" class="toast-container toast-top-right">
			<div class="toast toast-success" aria-live="polite" style="display: block;">
				<div class="toast-title text-center">Fees Updated Successfully</div>
			</div>
		</div>
	<?php endif; ?>
	<?php if (isset($FeesDeleteSuccess)) : ?>
		<div id="toast-container" class="toast-container toast-top-right">
			<div class="toast toast-success" aria-live="polite" style="display: block;">
				<div class="toast-title text-center">Fees Deleted Successfully</div>
			</div>
		</div>
	<?php endif; ?>
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Fees List</h3>
								<ul class="breadcrumb">
					...
					<div class="student-group-form">
						<div class="row">
							...
							<div class="col-lg-3 col-md-6">  
								<div class="form-group">
									<input type="text" class="form-control" placeholder="Search by Category ..." id="SearchByCategory">
								</div>
							</div>
									...
									<table id="DepartmentTable" class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td class="text-center"><?php echo $data->fees;?></td>
												<td class="text-center">
													<div>
														<a href="ViewFeeData?id=<?php echo $data->id;?>" class="btn btn-sm bg-success-light me-2">
															<i class="feather-eye"></i>
														</a>
														<a href="UpdateFees?id=<?php echo $data->id;?>" class="btn btn-sm bg-danger-light">
...
<script>
	 function deleteModal(id) {
            const modalYesButton = document.getElementById('cancelsubjectbutton');
                modalYesButton.href = 'deleteFees?id=' + id;
    	$('#deleteModal').modal('show');
		}

		document.addEventListener('DOMContentLoaded', function() {
        // var searchByIdInput = document.querySelector('#SearchById');
        var SearchByCategory = document.querySelector('#SearchByCategory');
        ...
        function filterTable() {
            ...
            var SearchByCategoryinput = SearchByCategory.value.trim().toLowerCase();
            ...
            tableRows.forEach(function(row) {
                ...
                var Category = row.querySelector('td:nth-child(2)').textContent.trim().toLowerCase();
				
                if ((SearchByCategoryinput === '' || Category.includes(SearchByCategoryinput))
					) {
        ...
        SearchByCategory.addEventListener('input', filterTable);
