...
<head>
		...
		<script>
			...
			function RedirecttoFeesList()
			{
				window.location.href="GetAllFees";
			}
			function RedirecttoFeesHistory()
			{
				window.location.href="FeesHistory";
			}
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						...
						<h3 class="fw-bold text-secondary">Fees</h3>
						</div>
					</div>
					<!-- /Page Header -->
					<div class="row">
					<div class="col-xl-3 col-sm-6 col-12 d-flex" onclick="RedirecttoFeesList();">
							<div class="card bg-comman w-100">
								<div class="card-body">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										<div class="db-info">
											<h3 class="text-secondary text-center">Fees</h3>
					...
					<div class="col-xl-3 col-sm-6 col-12 d-flex" onclick="RedirecttoFeesHistory();">
							<div class="card bg-comman w-100">
								<div class="card-body">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										<div class="db-info">
											<h3 class="text-secondary text-center">Fees History</h3>
											<!-- <h3 class="text-center text-white">50055</h3> -->
										</div>	
										<div class="db-icon">
											<img  src="<?php echo base_url(); ?>assets/img/StaffModelImages/Stff.png" width="60" height="60" alt="Dashboard Icon">
					...
					<div class="col-xl-3 col-sm-6 col-12 d-flex" onclick="RedirecttoPayFees();">
							<div class="card bg-comman w-100">
								<div class="card-body">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										<div class="db-info">
											<h3 class="text-secondary text-center">Pay Fees</h3>
											<!-- <h3 class="text-center text-white">50055</h3> -->
										</div>	
										<div class="db-icon">
											<img  src="<?php echo base_url(); ?>assets/img/StaffModelImages/Stff.png" width="60" height="60" alt="Dashboard Icon">
