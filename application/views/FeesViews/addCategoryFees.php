                ...
                <div class="content container-fluid">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="card">
								<div class="card-body">
									<form action="AddFeesPost" method="post" id="AddFeesForm">
										<div class="row">
											<div class="col-12">
                                            ...
                                            <div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													<label>Select Catgeory<span class="login-danger">*</span></label>
											...
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													...
													<input type="text" name="fees" id="fees" class="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
													<div class="invalid-feedback" style="display:none;"
											...
											<div class="col-12">
												<div class="student-submit">
													<button type="submit" class="btn btn-primary" id="AddFeesButton">Add Department</button>
												</div>
											</div>
										</div>
									</form>
