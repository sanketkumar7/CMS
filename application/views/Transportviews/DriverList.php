...
<head>
		...
		document.addEventListener('DOMContentLoaded', function() {
			var DriverAddSuccess = document.getElementById('toast-container');
			if (DriverAddSuccess) {
				DriverAddSuccess.style.display = 'block';
				setTimeout(function() {
					DriverAddSuccess.style.display = 'none';
				}, 3000);
			} 
		});
	</script>
	...
	<?php
	$DriverAddSuccess = $this->session->flashdata('DriverAddSuccess');
	$DriverDeleteSuccess = $this->session->flashdata('DriverDeleteSuccess');
	$DriverUpdateSuccess = $this->session->flashdata('DriverUpdateSuccess');
	$DrverdeleteFail = $this->session->flashdata('DrverdeleteFail');
	?>
	<?php if (isset($DriverAddSuccess)) : ?>
		<div id="toast-container" class="toast-container toast-top-right">
			<div class="toast toast-success" aria-live="polite" style="display: block;">
				<div class="toast-title text-center">Driver Added Successfully</div>
			</div>
		</div>
	<?php endif; ?>
	<?php if (isset($DriverUpdateSuccess)) : ?>
		<div id="toast-container" class="toast-container toast-top-right">
			<div class="toast toast-success" aria-live="polite" style="display: block;">
				<div class="toast-title text-center">Driver Updated Successfully</div>
			</div>
		</div>
	<?php endif; ?>
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-center">
														<div>
														<a href="ShowDriverData?id=<?php echo $driver->id; ?>" class="btn btn-sm bg-success-light me-2 ">
																<i class="feather-eye"></i>
															</a>
															<a href="EditDriverData?id=<?php echo $driver->id; ?>" class="btn btn-sm bg-danger-light">
																<i class="feather-edit"></i>
															</a>
															<button class="btn btn-sm bg-danger-light deleteButton" onclick="deleteModal('<?php echo $driver->id; ?>')" data-driverid="<?php echo $driver->id; ?>">
