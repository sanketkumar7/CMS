...
<body>
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                <h3 class="page-title" id="title">Add Stop</h3>
                                <ul class="breadcrumb">
                ...
                <div class="row" id="studentformcard">
                    <div class="col-sm-12">
                        ...
                        <div class="card comman-shadow">
                            <div class="card-body">
                                <form action="AddStopPost" method="post" id="addStopForm" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12 col-sm-4 d-none">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control" id="stopserialnumber" name="stopserialnumber">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Stop Name <span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" placeholder="Enter Stop Name" id="stopname" name="stopname" oninput="this.value = this.value.replace(/[^a-zA-Z\s\d]/g, '')">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Stop Address" id="stopaddress" name="stopaddress">
                                                <div class="invalid-feedback" style="display:none;" id="stopaddress_errormessage">
                                            ...
                                            <div class="form-group local-forms">
                                                ...
                                                <select class="form-select" name="routename" id="routename" style="height:45px;font-size:15px !important;">
                                                    ...
                                                    <?php foreach ($routes as $route) { ?>
                                                        <option value="<?php echo $route->routename; ?>"><?php echo $route->routename; ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Stop Fees" id="stopfees" name="stopfees" oninput="this.value = this.value.replace(/\D/g, '')">
                                        ...
                                        <input type="text" class="form-control d-none" placeholder="Enter Stop Address" id="routeid" name="routeid">
                                        <div class="col-12 mt-lg-4">
                                            <button type="submit" class="btn btn-primary" id="addStudentButton"><i class="fa-solid fa-user-plus"></i> Add Stop</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script>
		document.addEventListener('DOMContentLoaded', function() {
			document.getElementById('addStopForm').addEventListener('submit', function(event) {
