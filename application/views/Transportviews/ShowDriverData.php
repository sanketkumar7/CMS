                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-4 mb-3">
                                                <div class="form-group local-forms">
                                                    <img src="<?php echo base_url() . 'uploads/' . $driver->driverphoto; ?>" width="200" height="200" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Driver First Name" id="firstname" name="firstname" value="<?php echo $driver->firstname ?>" readonly>
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Driver Middle Name" id="middlename" name="middlename" value="<?php echo $driver->middlename ?>" readonly>
                                                </div>
                                                <div class="invalid-feedback" style="display:none;" id="religion_errormessage">
                                                    Stop Name is Required.
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Driver Last Name" id="lastname" name="lastname" value="<?php echo $driver->lastname ?>" readonly>
                                                </div>
                                                <div class="invalid-feedback" style="display:none;" id="religion_errormessage">
                                                    Stop Name is Required.
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms calendar-icon" id="DOB_calendar-icon">
                                                    ...
                                                    <input class="form-control datetimepicker" type="text" placeholder="DD-MM-YYYY" name="dateofbirth" id="dateofbirth" value="<?php echo $driver->dateofbirth ?>" readonly>
                                                    <div class="invalid-feedback" style="display:none;" id="insuranceexpirydate_errormessage">
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input type="text" class="form-control" id="gender" name="gender" value="<?php echo $driver->gender ?>" readonly>
                                                </div>
                                                <div class="invalid-feedback" style="display:none;" id="religion_errormessage">
                                                    Stop Name is Required.
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Contact Number" id="contactnumber" name="contactnumber" value="<?php echo $driver->contactnumber ?>" readonly>
                                                </div>
                                                <div class="invalid-feedback" style="display:none;" id="religion_errormessage">
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Email" id="email" name="email" value="<?php echo $driver->email ?>" readonly>
                                                </div>
                                                <div class="invalid-feedback" style="display:none;" id="religion_errormessage">
                                                    Email is Required.
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-4">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Address" id="address" name="address" value="<?php echo $driver->address ?>" readonly>
                                                </div>
                                                <div class="invalid-feedback" style="display:none;" id="religion_errormessage">
                                                    Address is Required.
                                                </div>
                                ...
                                <div class="row mt-5">
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" class="form-control" placeholder="Emrgency Contact Name" id="emergencycontactname" name="emergencycontactname" value="<?php echo $driver->emergencycontactname ?>" readonly>
                                        </div>
                                        <div class="invalid-feedback" style="display:none;" id="religion_errormessage">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" class="form-control" placeholder="Emergency Contact Number" id="emergencycontactnumber" name="emergencycontactnumber" value="<?php echo $driver->emergencycontactnumber ?>" readonly>
                                        </div>
                                        <div class="invalid-feedback" style="display:none;" id="religion_errormessage">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" class="form-control" placeholder="Emergency Contact Relationship" id="emergencycontactrelationship" name="emergencycontactrelationship" value="<?php echo $driver->emergencycontactrelationship ?>" readonly>
                                        </div>
                                        <div class="invalid-feedback" style="display:none;" id="religion_errormessage">
                                ...
                                <a href="EditDriverData?id=<?php echo $driver->id; ?>" class="btn btn-primary">
                                Edit
                            </a>
                            <button onclick="deleteModal('<?php echo $driver->id; ?>')" data-driverid="<?php echo $driver->id; ?>" class="btn btn-danger">
                                Delete
                            </button>
                            </div>
                                                  </div>
