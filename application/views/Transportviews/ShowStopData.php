                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-4 d-none">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control" id="id" name="id" value="<?php echo $stop->id; ?>" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Stop Name" id="stopname" name="stopname" value="<?php echo $stop->stopname; ?>" readonly>
                                            </div>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Stop Address" id="stopaddress" name="stopaddress" value="<?php echo $stop->stopaddress; ?>" readonly>
                                            </div>
                                            <div class="invalid-feedback" style="display:none;" id="religion_errormessage">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Stop Address<span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" placeholder="Enter Stop Address" id="routename" name="routename" value="<?php echo $stop->routename; ?>" readonly>
                                            </div>
                                            <div class="invalid-feedback" style="display:none;" id="religion_errormessage">
                                                Stop Address is Required.
                                            </div>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Stop Fees" id="stopfees" name="stopfees" value="<?php echo $stop->stopfees; ?>" readonly>
                                            </div>
                                            <div class="invalid-feedback" style="display:none;" id="religion_errormessage">
                                                Stop Fees is Required.
                                            </div>
                                        </div>
                                        <input type="text" class="form-control d-none" placeholder="Enter Stop Address" id="routeid" name="routeid" value="value<?php echo $stop->routeid; ?>"  readonly/>
                                        <div class="col-12 mt-lg-4">
                                        <a href="EditStopData?id=<?php echo $stop->id; ?>" class="btn btn-primary">
																Edit
															</a>
															<button id="Deletebutton" onclick="deleteModal('<?php echo $stop->id; ?>')" data-stopid="<?php echo $stop->id; ?>" class="btn btn-danger">
																Delete
															</button>                                        </div>
                                    </div>
                            </div>
