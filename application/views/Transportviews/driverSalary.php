                                    ...
                                    <div class="page-header">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-auto text-end float-end ms-auto download-grp">
												<a href="PaySalaryPage" class="btn btn-primary" id="gotoattendancepage">Pay <i class="fa-solid fa-indian-rupee-sign"></i></a>
											</div>
                                        </div>
                                    </div>
                                    <!-- /Page Header -->
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($salarydata as $salary) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $salary->driverid?></td>
                                                        <td class="text-center"><?php echo $salary->drivername?></td>
