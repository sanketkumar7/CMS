...
<body>
    ...
    <div class="main-wrapper">
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                <h3 class="page-title" id="title">Edit Driver</h3>
                                <ul class="breadcrumb">
                            ...
                            <div class="card-body">
                                ...
                                <div id="progrss-wizard" class="twitter-bs-wizard">
                                    ...
                                    <div class="tab-content twitter-bs-wizard-tab-content">
                                        <div class="tab-pane active" id="Driverdetails">
                                            <div class="mb-4">
                                                <h5>Driver Details</h5>
                                            </div>
                                            <form action="UpdateDriverWithid" method="post" enctype="multipart/form-data" id="UpdateDriverForm">
                                                <input type="text" name="firstname_lastname" id="firstname_lastname" class="d-none" value="<?php echo $driver->firstname_lastname; ?>">
                                                <input type="text" name="id" id="id" class="d-none" value="<?php echo $driver->id; ?>">
                                                <div class="row">
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms">
                                                            <label>Driver Serial No.<span class="login-danger">*</span></label>
                                                            <input type="text" class="form-control" id="driverid" name="driverid" value="<?php echo $driver->driverid; ?>" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Enter Driver First Name" id="firstname" name="firstname" value="<?php echo $driver->firstname; ?>" oninput="this.value=this.value.replace(/[^A-Za-z]/g, '')">
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Enter Driver Middle Name" id="middlename" name="middlename" value="<?php echo $driver->middlename; ?>" oninput="this.value=this.value.replace(/[^A-Za-z]/g, '')">
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Enter Driver Last Name" id="lastname" name="lastname" value="<?php echo  $driver->lastname; ?>" oninput="this.value=this.value.replace(/[^A-Za-z]/g, '')">
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms calendar-icon" id="DOB_calendar-icon">
                                                            ...
                                                            <input class="form-control datetimepicker" type="text" placeholder="DD-MM-YYYY" name="dateofbirth" id="dateofbirth" value="<?php echo $driver->dateofbirth; ?>" oninput="this.value=this.value.replace(/[^\d-]/g, '')" maxlength="10" minlength="10" minlength="10">
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Enter Contact Number" id="contactnumber" name="contactnumber" value="<?php echo $driver->contactnumber; ?>" oninput="this.value=this.value.replace(/\D/g, '')" minlength="10" maxlength="10">
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms">
                                                            ...
                                                            <input type="email" class="form-control" placeholder="Enter Email" id="email" name="email" value="<?php echo $driver->email; ?>">
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Enter Address" id="address" name="address" value="<?php echo $driver->address; ?>">
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Emrgency Contact Name" id="emergencycontactname" name="emergencycontactname" value="<?php echo $driver->emergencycontactname; ?>" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g, '')">
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Emergency Contact Number" id="emergencycontactnumber" name="emergencycontactnumber" value="<?php echo $driver->emergencycontactnumber; ?>" minlength="10" maxlength="10" oninput="this.value=this.value.replace(/\D/g, '')" minlength="10" maxlength="10">
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Emergency Contact Relationship" id="emergencycontactrelationship" value="<?php echo $driver->emergencycontactrelationship; ?>" name="emergencycontactrelationship" oninput="this.value=this.value.replace(/[^A-Za-z]/g, '')">
                                                    ...
                                                    <div class="form-group students-up-files">
                                                        ...
                                                        <div class="uplod">
                                                            <label class="file-upload image-upbtn mb-0">
                                                                Update photo<input type="file" accept=".jpeg, .jpg, .png" name="driverphoto" id="driverphoto" onchange="showphotoname();"/>
                                                            </label>
                                                            <p id="photoname" style="display:none"></p>
                                                    ...
                                                    <div class="col-12 col-sm-4 mb-3">
                                                        <div class="form-group local-forms">
                                                            <img src="<?php echo base_url() . 'uploads/' . $driver->driverphoto; ?>" width="140" height="140" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mt-5"> <button class="btn btn-primary" id="updatebutton">Update <i class="fa-solid fa-user-plus"></i></button>
        ...
        if (/[^a-zA-Z0-9\s.()]/.test(filename)) {
			...
			document.getElementById('specialcharactermessage').style.display='none';
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    document.getElementById('UpdateDriverForm').addEventListener('submit', function(event) {
                        var fieldIds = ['firstname', 'middlename', 'lastname', 'dateofbirth', 'gender', 'contactnumber', 'email', 'address', 'emergencycontactname', 'emergencycontactnumber', 'emergencycontactrelationship'];
                        for (var i = 0; i < fieldIds.length; i++) {
			...
			var filename = document.getElementById("driverphoto").value.split('\\').pop();
