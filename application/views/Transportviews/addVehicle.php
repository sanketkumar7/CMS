...
<body>
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                <h3 class="page-title" id="title">Add Vehicle</h3>
                                <ul class="breadcrumb">
                                ...
                                <div id="progrss-wizard" class="twitter-bs-wizard">
                                    ...
                                    <div class="tab-content twitter-bs-wizard-tab-content">
                                        <div class="tab-pane active" id="progress-seller-details">
                                            ...
                                            <form action="AddVehiclePost" method="post" enctype="multipart/form-data" id="AddVehicleForm">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-4 d-none">
                                                        <div class="form-group local-forms">
                                                            ...
                                                            <input type="text" class="form-control" id="vehicleserialnumber" name="vehicleserialnumber">
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms">
                                                            <label>Vehicle Reg. No.<span class="login-danger">*</span></label>
                                                            <input type="text" class="form-control" placeholder="e.g. MH 13 ABC" id="vehicleregnumber" name="vehicleregnumber" oninput="getvehicle()">
                                                            <div class="invalid-feedback" style="display:none;" id="vehicleregnumber_errormessage">
                                                                Vehicle Registered Number is Required.
                                                            </div>
                                                            <p id="errormessage" class="text-danger d-none" style="font-size:0.75rem;">Vehicle Already Registered</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms">
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Enter Vehicle company Name" id="vehiclecompany" name="vehiclecompany">
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <div class="form-group local-forms">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Enter Total Seating Capacity" id="totalseatingcapacity" name="totalseatingcapacity" oninput="this.value = this.value.replace(/[^0-9]/g, '')" maxlength="2">
                                                    ...
                                                    <div class="form-group students-up-files">
                                                        ...
                                                        <div class="uplod">
                                                            <label class="file-upload image-upbtn mb-0">
                                                                Choose image <input type="file" accept=".jpeg, .jpg, .png" name="busimages" id="busimages" onchange="showphotoname();"/>
                                                            </label>
                                        ...
                                        <div class="mt-5">  <button class="btn btn-primary" id="submitbutton">Add <i class="fa-solid fa-bus"></i></button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('AddVehicleForm').addEventListener('submit', function(event) {
                var fieldIds = ['vehicleregnumber', 'vehiclename', 'vehiclecompany', 'vehicletype', 'fueltype', 'totalseatingcapacity', 'busimages',];
    ...
    function getvehicle()
    {
        ...
        fetch("Fetchvehiclewithregnumber?vehicleregnumber=" + Vehicleregnumber)
        ...
        .then(data => {
            ...
            if(data.message=="Vehicle Found") {
                ...
                document.getElementById('vehiclename').setAttribute('readonly',true);
                document.getElementById('vehiclecompany').setAttribute('readonly',true);
                document.getElementById('totalseatingcapacity').setAttribute('readonly',true);
                document.getElementById('busimages').disabled=true;
                document.getElementById('submitbutton').disabled=true;
            }
            else{
                ...
                document.getElementById('vehiclecompany').removeAttribute('readonly');
                document.getElementById('totalseatingcapacity').removeAttribute('readonly');
                document.getElementById('busimages').disabled=false;
                document.getElementById('submitbutton').disabled=false;
            }
        })
        .catch(error => {
    ...
    function showphotoname() {
			var filename = document.getElementById("busimages").value.split('\\').pop();
