...
<!-- Mirrored from preschool.dreamstechnologies.com/template/edit-transport.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Jan 2024 08:37:21 GMT -->

<head>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0">
	<title>Edit Route Data</title>
			...
			<div class="content container-fluid">
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="card">
							<div class="card-body">
							<form action="UpdateRoute" method="post" id="UpdateRouteForm">
									<div class="row">
										<div class="col-12">
											<h5 class="form-title student-info">Edit Route Information <span><a href="javascript:;"></a></span></h5>
										</div>
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" class="form-control" placeholder="Enter Route Name" id="routename" name="routename" value="<?php echo $route->routename; ?>">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" class="form-control" placeholder="Route Start Point" id="routestartpoint" name="routestartpoint" value="<?php echo $route->routestartpoint;?>">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" class="form-control" placeholder="Route End Point" id="routeendpoint" name="routeendpoint" value="<?php echo $route->routeendpoint;?>">
										...
										<div class="col-12 mt-lg-4">
											<button type="submit" class="btn btn-primary" id="addStudentButton"><i class="fa-solid fa-route"></i> Update Route</button>
										</div>
									</div>
								</form>
	...
	<script>
		document.addEventListener('DOMContentLoaded', function() {
			document.getElementById('UpdateRouteForm').addEventListener('submit', function(event) {
					...
					var startpoint=document.getElementById('routestartpoint').value.trim();
					var endpoint=document.getElementById('routeendpoint').value.trim();
				if(routename=="" || startpoint=="" ||endpoint=="")
				{
					event.preventDefault();
					if(routename=="")
					{
						document.getElementById('routename_errormessage').style.display = 'block';
					}
					if(startpoint=="")
					{
						document.getElementById('routestartpoint_errormessage').style.display = 'block';

					}
					if(endpoint=="")
					{
						document.getElementById('routeendpoint_errormessage').style.display = 'block';
