...
<body>
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                <h3 class="page-title" id="title">Edit Stop</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="Transport">Transport </a></li>
                                    <li class=""><a href="StopsList">/Stops</a></li>
                ...
                <div class="row" id="studentformcard">
                    <div class="col-sm-12">
                        ...
                        <div class="card comman-shadow">
                            <div class="card-body">
                                <form action="UpdateStopPost" method="post" id="UpdateStopForm">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="form-title student-info">Stop Information</h5>
                                        </div>
                                        <div class="col-12 col-sm-4 d-none">
                                            <div class="form-group local-forms">
                                                <label>Stop Id<span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" id="id" name="id" value="<?php echo $stop->id; ?>">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Stop Serial No.<span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" id="stopserialnumber" name="stopserialnumber" value="<?php echo $stop->stopserialnumber; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Stop Name <span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" placeholder="Enter Stop Name" id="stopname" name="stopname" value="<?php echo $stop->stopname; ?>" oninput="this.value = this.value.replace(/[^a-zA-Z\s\d]/g, '')">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Stop Address<span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" placeholder="Enter Stop Address" id="stopaddress" name="stopaddress" value="<?php echo $stop->stopaddress; ?>">
                                                <div class="invalid-feedback" style="display:none;" id="rstopaddress_errormessage">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <select class="form-select" name="routename" id="routename" style="height:45px;font-size:15px !important;">
                                                    <option value="NA">Please Select Route</option>
                                                    <?php foreach ($routes as $route) { ?>
                                                        <option value="<?php echo $route->id; ?>" <?php echo ($route->routename == $stop->routename) ? 'selected' : ''; ?>><?php echo $route->routename; ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Stop Fees<span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" placeholder="Enter Stop Fees" id="stopfees" name="stopfees" value="<?php echo $stop->stopfees; ?>" oninput="this.value = this.value.replace(/\D/g, '')">
                                                <div class="invalid-feedback" style="display:none;" id="stopfees_errormessage">
                                                Stop Fees is Required.
                                            </div>
                                            </div>    
                                        </div>
                                        <input type="text" class="form-control d-none" placeholder="Enter Stop Address" id="routeid" name="routeid" value="<?php echo $stop->routeid; ?>">
                                        <div class="col-12 mt-lg-4">
                                            <button type="submit" class="btn btn-primary" id="addStudentButton"><i class="fa-solid fa-user-plus"></i> Update Stop</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script>
		document.addEventListener('DOMContentLoaded', function() {
			document.getElementById('UpdateStopForm').addEventListener('submit', function(event) {
					var fieldIds = ['stopname','stopaddress','routename','stopfees','routestartpoint','routeendpoint','routestarttime','routeendtime','routedistance','routetotaltime'];
