									...
									<div class="row">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="bookid" class="form-control" id="bookid" placeholder="Book Id" oninput="checkbookid()">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="booktitle" id="booktitle" placeholder="Mechanics" class="form-control" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g, '');checkbookname();">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="authors" id="authors" placeholder="Mechanics" class="form-control" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g, '');">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="publisher" id="publisher" placeholder="Technical Publications" class="form-control" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g, '');">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="edition" id="edition" placeholder="first" class="form-control" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g, '');">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="yearofpublication" id="yearofpublication" placeholder="2024" class="form-control" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g, '');">
												<p id="bookexisterror" class="text-danger" style="display:none;font-size:0.7rem">Book With same name already exists</p>
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="language" id="language" placeholder="English" class="form-control" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g, '');">
												<p id="bookexisterror" class="text-danger" style="display:none;font-size:0.7rem">Book With same name already exists</p>
												<div class="invalid-feedback" style="display:none;" id="booktitle_errormessage">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="noofpages" id="noofpages" placeholder="300" class="form-control" oninput="this.value=this.value.replace(/[0-9]/g, '');">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="count" id="count" placeholder="5" class="form-control" oninput="this.value=this.value.replace(/[^0-9]/g, '');">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="shelflocation" id="shelflocation" placeholder="10" class="form-control" oninput="this.value=this.value.replace(/[^0-9]/g, '');">
