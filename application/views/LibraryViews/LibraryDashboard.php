...
<head>
		...
		<script>
			...
			function RedirecttoIssueBooks()
			{
				window.location.href="IssuedBooksList";
			}
			
			function RedirecttoBooksList()
			{
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						...
						<h3 class="fw-bold text-secondary">Department</h3>
						</div>
					</div>
					<!-- /Page Header -->
					<div class="row">
					<div class="col-xl-3 col-sm-6 col-12 d-flex" onclick="RedirecttoBooksList();">
							<div class="card bg-comman w-100">
								<div class="card-body">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										<div class="db-info">
											<h3 class="text-secondary text-center">Books</h3>
					...
					<div class="col-xl-3 col-sm-6 col-12 d-flex" onclick="RedirecttoIssueBooks();">
							<div class="card bg-comman w-100">
								<div class="card-body">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										<div class="db-info">
											<h3 class="text-secondary text-center">Issue Book</h3>
											<!-- <h3 class="text-center text-white">50055</h3> -->
										</div>	
										<div class="db-icon">
											<img  src="<?php echo base_url(); ?>assets/img/StaffModelImages/Stff.png" width="60" height="60" alt="Dashboard Icon">
					...
					<div class="col-xl-3 col-sm-6 col-12 d-flex" onclick="RedirecttoManagementDepartment();">
							<div class="card bg-comman w-100">
								<div class="card-body">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										<div class="db-info">
											<h3 class="text-secondary text-center">Return Book</h3>
											<!-- <h3 class="text-center text-white">50055</h3> -->
										</div>	
										<div class="db-icon">
											<img  src="<?php echo base_url(); ?>assets/img/StaffModelImages/Stff.png" width="60" height="60" alt="Dashboard Icon">
