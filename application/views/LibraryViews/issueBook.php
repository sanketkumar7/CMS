...
<body>
			...
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title">Issue Book</h3>
							<ul class="breadcrumb">
						...
						<div class="card">
							<div class="card-body">
								<form action="IssueBookPost" method="post" id="IssueBookForm">
									<div class="row">
										<div class="col-12">
											<h4 class="form-title"><span>Issue Book</span></h4>
										</div>
										<div class="col-12">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="bookid" class="form-control" id="bookid" placeholder="Book Id" oninput="getBook()">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="booktitle" id="booktitle" placeholder="Mechanics" class="form-control" readonly>
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="studentid" id="studentid" placeholder="Technical Publications" class="form-control" oninput="getStudent()">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="studentname" id="studentname" placeholder="first" class="form-control"  readonly>
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="course" id="course" placeholder="2024" class="form-control"  readonly>
												<p id="bookexisterror" class="text-danger" style="display:none;font-size:0.7rem">Book With same name already exists</p>
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="year" id="year" placeholder="English" class="form-control"  readonly>
												<p id="bookexisterror" class="text-danger" style="display:none;font-size:0.7rem">Book With same name already exists</p>
												<div class="invalid-feedback" style="display:none;" id="booktitle_errormessage">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="department" id="department" placeholder="English" class="form-control"  readonly>
												<p id="bookexisterror" class="text-danger" style="display:none;font-size:0.7rem">Book With same name already exists</p>
												<div class="invalid-feedback" style="display:none;" id="booktitle_errormessage">
													Language is Required.
												</div>
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" name="duedate" id="duedate" placeholder="5" class="form-control" >
										...
										<div class="col-12">
											<div class="student-submit">
												<button type="submit" class="btn btn-primary" id="IssueBookButton">Issue Book</button>
											</div>
										</div>
									</div>
								</form>
	...
	<script>
            ...
            var formattedDueDate =dueDay  + '-' + dueMonth + '-' + dueYear;
