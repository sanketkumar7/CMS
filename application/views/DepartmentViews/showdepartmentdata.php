										...
										<div class="row">
											...
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													...
													<input type="text" class="form-control" name="departmentname" value="<?php echo $data->departmentname;?>" readOnly>
												</div>
											</div>
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													<label>Course <span class="login-danger">*</span></label>
                                                    <input type="text" class="form-control" name="course" value="<?php echo $data->course;?>" readOnly>
												</div>
											</div>
											<!-- <div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
											...
											<div class="col-12">
												<div>
													<a class="btn btn-primary" href="EditDepartment?id=<?php echo $data->id;?>">Edit</a>
