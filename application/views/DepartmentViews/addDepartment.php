                ...
                <div class="content container-fluid">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="card">
								<div class="card-body">
									<form action="AddDepartmentPost" method="post" id="AddDepartmentForm">
										<div class="row">
											<div class="col-12">
											...
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													...
													<input type="text" name="departmentname" id="departmentname" class="form-control" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g, '');checkdeptname();">
											...
											<div class="col-12">
												<div class="student-submit">
													<button type="submit" class="btn btn-primary" id="AddDepartmentButton">Add Department</button>
												</div>
											</div>
										</div>
									</form>
