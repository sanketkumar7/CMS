...
<head>
        ...
        <title>Timetable Protototyes</title>
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Timetable Protototyes</h3>
								<ul class="breadcrumb">
								<li><a href="Department">Timetable</a></li>
									<!-- <li class=""><a href="ManageDepartment">/ Manage Department</a></li> -->
									<li class="breadcrumb-item active">/ TimeTable Protototyes</li>
								</ul>
							</div>
						</div>
					</div>
									...
									<div class="page-header">
										<div class="row align-items-center">
											...
											<div class="col-auto text-end float-end ms-auto download-grp">
												<a href="CreatTimeTablePrototype" class="btn btn-primary"><i class="fas fa-plus"></i></a>
											</div>
										</div>
									</div>
									<!-- /Page Header -->
