...
<head>
		...
		<script>
			...
			function RedirecttoTimeTableProtoList()
			{
				window.location.href="TimeTableProtoList";
			}
			
			function RedirecttoCreatTimeTablePrototype()
			{
				window.location.href="CreatTimeTablePrototype";
			}

			function RedirecttoTimeTableList()
			{
				window.location.href="TimeTableList";
			}
			function RedirecttoAddTimeTable()
			{
				window.location.href="AddTimeTable";
			}
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						...
						<h3 class="fw-bold text-secondary">Timetable</h3>
						</div>
					</div>
					<!-- /Page Header -->
					<div class="row">
					<div class="col-xl-3 col-sm-6 col-12 d-flex" onclick="RedirecttoTimeTableProtoList();">
							<div class="card bg-comman w-100">
								<div class="card-body">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										<div class="db-info">
											<h3 class="text-secondary text-center">Timetable Prototypes</h3>
						...
						<!-- <div class="col-xl-3 col-sm-6 col-12 d-flex" onclick="RedirecttoCreatTimeTablePrototype()">
							<div class="card bg-comman w-100">
								<div class="card-body">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										<div class="db-info">
										<h3 class="fw-bold text-center text-secondary mx-auto">Timetable</h3>
										</div>	
										<div class="db-icon">
						...
						<div class="col-xl-3 col-sm-6 col-12 d-flex" id="RouteCard" onclick="RedirecttoTimeTableList();">
							<div class="card bg-comman w-100">
								<div class="card-body">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										<div class="db-info">
						...
						<!-- <div class="col-xl-3 col-sm-6 col-12 d-flex" onclick="RedirecttoAddTimeTable()">
							<div class="card bg-comman w-100">
								<div class="card-body">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										<div class="db-info">
