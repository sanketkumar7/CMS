...
<body>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <select class="form-control" name="department" id="department" onchange="populateCourse();">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <select class="form-control" name="course" id="course" onchange="Populateyear();">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Number of Lectures<span class="login-danger">*</span></label>
                                                <select class="form-control" name="gender" id="gender">
                                                    <option value="NA">Select</option>
                                                    <option>Male</option>
                                                    <option>Female</option>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Lecture Duration<span class="login-danger">*</span></label>
                                                <select class="form-control" name="gender" id="gender">
                                                    <option value="NA">Select</option>
                                                    <option>Male</option>
                                                    <option>Female</option>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Number of Breaks<span class="login-danger">*</span></label>
                                                <select class="form-control" name="gender" id="gender">
                                                    <option value="NA">Select</option>
                                                    <option>Male</option>
                                                    <option>Female</option>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Break Duration<span class="login-danger">*</span></label>
                                                <select class="form-control" name="gender" id="gender">
                                                    <option value="NA">Select</option>
                                                    <option>Male</option>
                                                    <option>Female</option>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Break<span class="login-danger">*</span></label>
                                                <select class="form-control" name="gender" id="gender">
                                                    <option value="NA">Select</option>
                                                    <option>Male</option>
                                                    <option>Female</option>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Workdays<span class="login-danger">*</span></label>
                                                <select class="form-control" name="gender" id="gender">
                                                    <option value="NA">Select</option>
                                                    <option>Male</option>
                                                    <option>Female</option>
    ...
    <script>
        ...
        function populateCourse() {
            ...
            fetch("getcoursesforthedeaprtment?department=" + department)
                .then(response => {
                    if (!response.ok) {
                        return;
                    }
