            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="UpdateStaffPost" id="UpdateStaffForm" enctype="multipart/form-data"
                                    method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control" name="staffid"
                                                    value="<?php echo $data->staffid; ?>" placeholder="Teacher ID"
                                                    readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?php echo $data->firstname; ?>" name="firstname"
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?php echo $data->middlename; ?>" name="middlename"
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?php echo $data->lastname; ?>" name="lastname"
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control " value="<?php echo $data->gender ?>"
                                                    type="text" readonly>
                                                <!-- <select class="form-control" name="gender" id="gender">
                                                    <option value="NA">Select Gender</option>
                                                    <option <?php echo ($data->gender == "Male") ? 'selected' : ''; ?>>
                                                        Male</option>
                                                    <option
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms calendar-icon" id="dobcalendericon">
                                                ...
                                                <input class="form-control datetimepicker"
                                                    value="<?php echo $data->dateofbirth; ?>" type="text"
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    placeholder="Enter Phone" name="contactnumber" id="contactnumber"
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Aadhar"
                                                    ...
                                                    oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                                    minlength="14" maxlength="14" oninput="checkadhar();" value="<?php echo $data->aadhar; ?>" readonly>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" placeholder="0"
                                                    name="designation" id="designation" value="<?php echo $data->designation; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms calendar-icon" id="joiningcalendericon">
                                                ...
                                                <input class="form-control datetimepicker" type="text"
                                                    value="<?php echo $data->joiningdate; ?>" placeholder="DD-MM-YYYY"
                                                    name="joiningdate" id="joiningdate" readonly>
                                                <div class="invalid-feedback" style="display:none;"
                                        ...
                                        <div class="col-12 col-sm-5 mb-5">
                                            <div class="form-group students-up-files">
                                                <p>Profile Photo</p><span class="fw-bold"
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="email" class="form-control"
                                                    value="<?php echo $data->loginemail; ?>" name="loginemail"
                                                    placeholder="Enter Mail Id" id="loginemail" readonly>
                                                <div class="invalid-feedback" style="display:none;"
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    placeholder="Enter Password" id="password" readonly>
                                                <div class="invalid-feedback" style="display:none;"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    placeholder="Enter address" id="address" readonly>
                                                <div class="invalid-feedback" style="display:none;"
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?php echo $data->city; ?>" name="city"
                                                    placeholder="Enter City" id="city" readonly>
                                                <div class="invalid-feedback" style="display:none;"
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?php echo $data->state; ?>" name="state"
                                                    placeholder="Enter State" id="state" readonly>
                                                <div class="invalid-feedback" style="display:none;"
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="<?php echo $data->country; ?>" name="country"
                                                    placeholder="Enter Country" id="country" readonly>
                                                <div class="invalid-feedback" style="display:none;"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <button class="btn btn-danger"
                                                onclick="deleteModal(<?php echo $data->id ?>);">
                                                Delete
                                            </button>
                                        </div>
                                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('UpdateStaffForm').addEventListener('submit', function(event) {
            var fieldIds = ['firstname', 'middlename', 'lastname', 'gender', 'dateofbirth',
                'contactnumber', 'email', 'joiningdate', 'loginemail', 'password', 'address',
                'city', 'state', 'country'
            ];
