...
<head>
	...
	<title>Check in Check out Data</title>
...
<body>
	<?php
	$CheckinSuccess = $this->session->flashdata('CheckinSuccess');
	$CheckoutSuccess = $this->session->flashdata('CheckoutSuccess');

	?>
	<?php if (isset($CheckinSuccess)) : ?>
		<div id="toast-container" class="toast-container toast-top-right">
			<div class="toast toast-success" aria-live="polite" style="display: block;">
				<div class="toast-title text-center">Check in Successfull</div>
			</div>
		</div>
	<?php endif; ?>
	<?php if (isset($CheckoutSuccess)) : ?>
		<div id="toast-container" class="toast-container toast-top-right">
			<div class="toast toast-success" aria-live="polite" style="display: block;">
				<div class="toast-title text-center">Check out Successfull</div>
			</div>
		</div>
	<?php endif; ?>
			...
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title">Check In-Out Data</h3>
							<ul class="breadcrumb">
								<li><a href="AdminStaffDashboard">Staff</a></li>
								<li class="breadcrumb-item active">/ Checkin-checkout Data</li>
							</ul>
						</div>
					</div>
				</div>
								...
								<div class="page-header">
									<div class="row align-items-center">
										...
										<div class="col-auto text-end float-end ms-auto download-grp">
											...
											<a href="MarkStaffAttendance" class="btn btn-primary" id="gotoattendancepage">Check In/Out</a>
										</div>
									</div>
								</div>
								<!-- /Page Header -->
										...
										<tbody>
											...
											foreach ($data as $staff) { ?>
												<tr>
													...
													<?php if($staff->intime!=""):?>
													<td class="text-center"><?php echo $staff->intime; ?></td>
													<?php else: ?>
														<td class="text-center">_ _</td>
													<?php endif?>
													<?php if($staff->outtime!=""):?>	
													<td class="text-center"><?php echo $staff->outtime; ?></td>
													<?php else: ?>
														<td class="text-center">_ _</td>
													<?php endif?>
												</tr>
