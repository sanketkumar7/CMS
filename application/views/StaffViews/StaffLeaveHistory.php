...
<head>
	...
	<script>
		document.addEventListener('DOMContentLoaded', function() {
			var StaffLeaveSuccess = document.getElementById('toast-container');
			if (StaffLeaveSuccess) {
				StaffLeaveSuccess.style.display = 'block';
				setTimeout(function() {
					StaffLeaveSuccess.style.display = 'none';
				}, 3000);
			}
		});
	</script>
...
<body>
	...
	<?php
	$StaffLeaveSuccess = $this->session->flashdata('StaffLeaveSuccess');
	$StaffLeaveCancelSuccess = $this->session->flashdata('StaffLeaveCancelSuccess');
	$LeaveUpdateSuccess = $this->session->flashdata('DriverUpdateSuccess');
	?>
	<?php if (isset($StaffLeaveSuccess)) : ?>
		<div id="toast-container" class="toast-container toast-top-right">
			<div class="toast toast-success" aria-live="polite" style="display: block;">
				<div class="toast-title text-center">Leave Request Sent Successfully</div>
			</div>
		</div>
	<?php endif; ?>
	<?php if (isset($StaffLeaveCancelSuccess)) : ?>
		<div id="toast-container" class="toast-container toast-top-right">
			<div class="toast toast-success" aria-live="polite" style="display: block;">
				<div class="toast-title text-center">Leave Request Cancelled Successfully</div>
			</div>
		</div>
	<?php endif; ?>
	<?php if (isset($LeaveUpdateSuccess)) : ?>
		<div id="toast-container" class="toast-container toast-top-right">
			<div class="toast toast-success" aria-live="polite" style="display: block;">
			...
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title">Leave History</h3>
							<ul class="breadcrumb">
									...
									<table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
										<thead class="student-thread">
											<tr>
												...
												<th class="text-center">Leave Span(In Days)</th>
										...
										<tbody>
											...
											foreach ($data as $data) { ?>
												<tr>
													...
													<td class="text-center"><button class="btn btn-primary m-1 text-white" disabled>Edit</button><button class="btn btn-danger text-white m-1" disabled>Cancel</button></td>
													<?php else:?>
														<td class="text-center"><a href="" class="btn btn-primary m-1 text-white">Edit</a><a href="" class="btn btn-danger text-white">Cancel</a></td>
														<?php endif?>
													<?php ?> -->
												</tr>
											<?php } ?>
