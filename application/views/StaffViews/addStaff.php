    ...
    <body>
								...
								<div class="card-body">
									<form action="AddStaffPost" id="AddStaffForm" enctype="multipart/form-data" method="post">
										<div class="row">
                                                    ...
                                                    <div class="form-group students-up-files">
                                                        ...
                                                        <div class="uplod">
                                                            <label class="file-upload image-upbtn mb-0">
                                                                Choose image <input type="file" accept=".jpeg, .jpg, .png" name="profilephoto" id="profilephoto" />
                                                            </label>
                                                        </div>
											...
											<div class="col-12">
													<button type="submit" class="btn btn-primary" id="AddStaffButton">Add Staff</button>
											</div>
										</div>
									</form>
								</div>
		...
		<script>
			...
			document.getElementById('AddStaffForm').addEventListener('submit', function(event) {
					var fieldIds = ['firstname','middlename','lastname','gender','dateofbirth','contactnumber','email','joiningdate','profilephoto','loginemail','password','address', 'city', 'state', 'country'];
