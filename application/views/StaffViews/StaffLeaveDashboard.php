							...
							<div class="card bg-comman w-100">
								<div class="card-body">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										...
										<div class="db-icon">
											<img  src="<?php echo base_url(); ?>assets/img/bsremovebg.png" width="75" height="75" alt="Dashboard Icon">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card bg-comman w-100">
								<div class="card-body">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										...
										<div class="db-icon">
											<img  src="<?php echo base_url(); ?>assets/img/dr.png" width="45" height="45" alt="Dashboard Icon">
										</div>	
									</div>
								</div>
							</div>
