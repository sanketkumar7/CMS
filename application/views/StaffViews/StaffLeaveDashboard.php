...
<head>
    ...
    function RedirecttoApplypage() {
        window.location.href = "ApplyLeavePage";
    }
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <h3 class="fw-bold text-secondary">Leave</h3>
                    </div>
                </div>
                <!-- /Page Header -->
                <div class="row">
                        ...
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h5 class="text-secondary fw-bold text-center">Apply Leave</h5>
                                        <!-- <h3 class="text-center text-white">50055</h3> -->
                                    </div>
                                    <div class="db-icon">
                                        <img src="<?php echo base_url(); ?>assets/img/StaffModelImages/attend.png"
                                            width="75" height="75" alt="Dashboard Icon">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 d-flex" onclick="RedirecttoLeaveHistorypage()">
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h5 class="fw-bold text-center text-secondary mx-auto">Leave History</h5>
                                    </div>
                                    <div class="db-icon">
                                        <img src="<?php echo base_url(); ?>assets/img/StaffModelImages/leave.png"
                                            width="45" height="45" alt="Dashboard Icon">
                                    </div>
                                </div>
                            </div>
                        </div>
