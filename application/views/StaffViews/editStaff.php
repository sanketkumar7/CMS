									...
									<div class="row">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" class="form-control" value="<?php echo $data->firstname; ?>" name="firstname" placeholder="Enter First Name" id="firstname" oninput="this.value=this.value.replace(/[^A-Za-z]/g, '')">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" class="form-control" value="<?php echo $data->middlename; ?>" name="middlename" placeholder="Enter Middle Name" id="middlename" oninput="this.value=this.value.replace(/[^A-Za-z]/g, '')">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" class="form-control" value="<?php echo $data->lastname; ?>" name="lastname" placeholder="Enter Last Name" id="lastname" oninput="this.value=this.value.replace(/[^A-Za-z]/g, '')">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms calendar-icon" id="dobcalendericon">
												...
												<input class="form-control datetimepicker" value="<?php echo $data->dateofbirth; ?>" type="text" placeholder="DD-MM-YYYY" name="dateofbirth" id="dateofbirth">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" class="form-control" value="<?php echo $data->contactnumber; ?>" placeholder="Enter Phone" name="contactnumber" id="contactnumber" oninput="this.value = this.value.replace(/[^0-9]/g, '')" minlength="10" maxlength="10">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" class="form-control" value="<?php echo $data->email; ?>" placeholder="Enter Email" name="email" id="email">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms calendar-icon" id="joiningcalendericon">
												...
												<input class="form-control datetimepicker" type="text" value="<?php echo $data->joiningdate; ?>" placeholder="DD-MM-YYYY" name="joiningdate" id="joiningdate">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="email" class="form-control" value="<?php echo $data->loginemail; ?>" name="loginemail" placeholder="Enter Mail Id" id="loginemail" oninput="checkemail();" minlenght="10"> 
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" class="form-control" value="<?php echo $data->password; ?>" name="password" placeholder="Enter Password" id="password">
										...
										<div class="col-12">
											<div class="form-group local-forms">
												...
												<input type="text" class="form-control" value="<?php echo $data->address; ?>" name="address" placeholder="Enter address" id="address">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" class="form-control" value="<?php echo $data->city; ?>" name="city" placeholder="Enter City" id="city">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" class="form-control" value="<?php echo $data->state; ?>" name="state" placeholder="Enter State" id="state">
										...
										<div class="col-12 col-sm-4">
											<div class="form-group local-forms">
												...
												<input type="text" class="form-control" value="<?php echo $data->country; ?>" name="country" placeholder="Enter Country" id="country">
