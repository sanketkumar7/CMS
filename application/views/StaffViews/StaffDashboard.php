...
<body>
    ...
    <div class="main-wrapper">
        ...
        $(document).ready(function() {
            $('input[placeholder="Search by ID"], input[placeholder="Search by Name"], input[placeholder="Search by Phone ..."]')
                .on('input', function() {
                    ...
                    var driverPhone = $('input[placeholder="Search by Phone ..."]').val().trim()
                        .toLowerCase();
                    console
