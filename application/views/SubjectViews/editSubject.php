										...
										<div class="row">
											...
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													...
													<input type="text" class="form-control" name="subjectname" id="subjectname" value="<?php echo $data->subjectname;?>" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g, '')">
											...
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
                                                    ...
                                                    <?php foreach($department as $dept){?>
														<option value="<?php echo $dept->departmentid; ?>" <?php echo ($data->departmentid == $dept->departmentid) ? "selected" : ""; ?>><?php echo $dept->departmentname; ?></option>
                                                        <?php }?>
                                                </select>
												<div class="invalid-feedback" style="display:none;"
