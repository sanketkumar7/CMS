...
<!-- 
		...
		<script>
			...
			function RedirecttoManageSubjectPage(event)
			{
				event.preventDefault();
				window.location.href="ManageSubject";
			}
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						...
						<h3 class="fw-bold text-secondary">Subject</h3>
						</div>
					</div>
					<!-- /Page Header -->
					<div class="row">
					<div class="col-xl-3 col-sm-6 col-12 d-flex" onclick="RedirecttoManageSubjectPage(event);">
							<div class="card bg-comman w-100">
								<div class="card-body">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										<div class="db-info">
											<h3 class="text-secondary text-center">Manage Subject</h3>
