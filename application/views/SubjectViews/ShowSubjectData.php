	...
	<div class="modal fade contentmodal show" id="deleteModal" tabindex="-1" aria-modal="true" role="dialog">
										...
										<div class="row">
											...
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													...
													<input type="text" class="form-control" value="<?php echo $data->subjectid?>" readonly>
												</div>
											</div>
											...
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													...
													<input type="text" class="form-control" value="<?php echo $data->subjectname?>" readonly>
												</div>
											</div>
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													<label>Department <span class="login-danger">*</span></label>
													<input type="text" class="form-control" value="<?php echo $data->departmentname?>" readonly>
												</div>
											</div>
											<div class="col-12">
												<div>
													<a class="btn btn-primary" href="EditSubject?id=<?php echo $data->id;?>">Edit</a>
	 ...
	 function deleteModal(subjectid) {
            const modalYesButton = document.getElementById('cancelsubjectbutton');
                modalYesButton.href = 'DeleteSubject?id=' + subjectid;
