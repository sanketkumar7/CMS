...
<!-- Mirrored from preschool.dreamstechnologies.com/template/subjects.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Jan 2024 08:34:11 GMT -->
<head>
        <meta charset="utf-8">
		...
		document.addEventListener('DOMContentLoaded', function() {
			var SubjectSuccess = document.getElementById('toast-container');
			if (SubjectSuccess) {
    ...
    <body>
	<?php
	$SubjectAddSuccess = $this->session->flashdata('SubjectAddSuccess');
	$SubjectUpdateSuccess = $this->session->flashdata('SubjectUpdateSuccess');
	$SubjectDeleteSuccess = $this->session->flashdata('SubjectDeleteSuccess');
	?>
	<?php if (isset($SubjectAddSuccess)) : ?>
		<div id="toast-container" class="toast-container toast-top-right">
			<div class="toast toast-success" aria-live="polite" style="display: block;">
				<div class="toast-title text-center">Subject Added Successfully</div>
			</div>
		</div>
	<?php endif; ?>
	<?php if (isset($SubjectUpdateSuccess)) : ?>
		<div id="toast-container" class="toast-container toast-top-right">
			<div class="toast toast-success" aria-live="polite" style="display: block;">
				<div class="toast-title text-center">Subject Updated Successfully</div>
			</div>
		</div>
	<?php endif; ?>
	<?php if (isset($SubjectDeleteSuccess)) : ?>
		<div id="toast-container" class="toast-container toast-top-right">
			<div class="toast toast-success" aria-live="polite" style="display: block;">
				<div class="toast-title text-center">Subject Deleted Successfully</div>
			</div>
		</div>
	<?php endif; ?>
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								...
								<li class="breadcrumb-item"><a href="Subject" style="font-weight:bold;">Subject</a></li>
					...
					<div class="student-group-form">
						<div class="row">
							...
							<div class="col-lg-4 col-md-6">  
								<div class="form-group">
									<input type="text" class="form-control" placeholder="Search by Department ..." id="SearchByDepartment">
								</div>
							</div>
							<div class="col-lg-2">  
								...
								<div class="card-body">
									...
									<div class="page-header">
										<div class="row align-items-center">
											...
											<div class="col-auto text-end float-end ms-auto download-grp">
												<a href="AddSubject" class="btn btn-primary"><i class="fas fa-plus"></i></a>
											</div>
										</div>
									</div>
									<!-- /Page Header -->
									...
									<div class="table-responsive">
										<table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
											...
											<tbody>
												<?php $i=0; foreach($subject as $sub){?>
												<tr>
													<td class="text-center"><?php echo ++$i?></td>
													<td class="text-center"><?php echo $sub->subjectid;?></td>
													<td class="text-center">
													<?php echo $sub->subjectname;?>
													</td>
													<td class="text-center"><?php echo $sub->departmentname;?></td>
													<td class="text-center">
														<div>
														<a href="ShowSubjectData?id=<?php echo $sub->id;?>" class="btn btn-sm bg-success-light me-2">
															<i class="feather-eye"></i>
														</a>
														<a href="EditSubject?id=<?php echo $sub->id;?>" class="btn btn-sm bg-danger-light">
															<i class="feather-edit"></i>
														</a>
														<button  class="btn bg-danger-light" onclick="deleteModal(<?php echo $sub->id; ?>);">
	...
	<script src="<?php echo base_url() ?>assets/plugins/toastr/toastr.js"></script>
	 ...
	 function deleteModal(departmentid) {
            const modalYesButton = document.getElementById('cancelsubjectbutton');
                modalYesButton.href = 'DeleteSubject?id=' + departmentid;
        ...
        var searchBycontactnumberInput = document.querySelector('#SearchByDepartment');
