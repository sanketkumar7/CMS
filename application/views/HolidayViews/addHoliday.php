                ...
                <div class="content container-fluid">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="card">
								<div class="card-body">
									<form action="AddHolidayPost" method="post" id="AddHolidayForm">
										<div class="row">
											<div class="col-12">
											...
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													...
													<input type="text" name="holidayname" id="holidayname" class="form-control" placeholder="name" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g, '');checkdeptname();">
													<p id="holidayexisterror" class="text-danger" style="display:none;font-size:0.7rem" >Department With same name already exists</p>
											...
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													...
													<input type="date" name="date" id="date" class="form-control" placeholder="dd-mm-yyyy" onchange="checkdate();checkSunday();">
												...
												<p class="text-danger" id="sundaydate" style="display:none;font-size:0.75rem;">Sunday selected</p>
												</div>
											</div>
											<!-- <div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
											...
											<div class="col-12">
												<div class="student-submit">
													<button type="submit" class="btn btn-primary" id="AddHolidayButton">Add Holiday</button>
												</div>
											</div>
										</div>
									</form>
	...
	function checkdate()
	{
		...
		.then(response =>{
			...
			if(data.message=="Holiday on that date Exists")
			{
				...
				document.getElementById("AddHolidayButton").disabled=true;
			}
			else{
				document.getElementById("datetexisterror").style.display="none";
				document.getElementById("AddHolidayButton").disabled=false;
			}
		}).catch(error =>{
			console.log(error);
		});
