										...
										<div class="row">
											...
											<div class="col-12 col-sm-4 d-none">  
												<div class="form-group local-forms">
													...
													<input type="text" class="form-control" name="id" value="<?php echo $Holiday->id;?>">
												</div>
											</div>
											...
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													...
													<input type="text" class="form-control" name="departmentname" value="<?php echo $Holiday->holidayname;?>" readOnly>
												</div>
											</div>
											<div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
													<label>Holiday Date<span class="login-danger">*</span></label>
                                                    <input type="date" class="form-control" name="course" value="<?php echo $Holiday->date;?>" readOnly>
												</div>
											</div>
											<!-- <div class="col-12 col-sm-4">  
												<div class="form-group local-forms">
											...
											<div class="col-12">
												<div>
													<a class="btn btn-primary" href="UpdateHoliday?id=<?php echo $Holiday->id;?>">Edit</a>
													<button  class="btn btn-danger" onclick="deleteModal(<?php echo $Holiday->id; ?>);">
															Delete</button>												</div>
											</div>
										</div>
								</div>
